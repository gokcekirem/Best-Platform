...
object ClearMarketTimeFlow {
    ...
    /**
     * Initiates the [ClearMarketTimeFlow]
    ...
    class Initiator(
        ...
        override fun call(): SignedTransaction {
            ...
            val txCommand =
                Command(MarketTimeContract.Commands.ClearMarketTime(), outputState.participants.map { it.owningKey })
    ...
    /**
     * Responds to the [ClearMarketTimeFlow]
     *
